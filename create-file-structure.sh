...
LUA_FOLDER_CLIENT="$LUA_FOLDER/client/${PROJECT_NAME_PREFIXED}"
LUA_FOLDER_SERVER="${LUA_FOLDER}/server/${PROJECT_NAME_PREFIXED}"
LUA_FOLDER_SHARED="${LUA_FOLDER}/shared/${PROJECT_NAME_PREFIXED}"
...
mkdir -p "$LUA_FOLDER_SERVER"
mkdir -p "$LUA_FOLDER_SHARED"
